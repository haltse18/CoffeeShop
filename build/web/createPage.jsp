<%-- 
    Document   : createPage
    Created on : Jan 17, 2021, 9:44:10 AM
                        ...
                        <div data-section-id="collection-template" data-section-type="collection-template"
                            ...
                            <div class="grid grid--uniform" role="list">
                                <form action="MainController" enctype="multipart/form-data" method="POST" >
                                    ...
                                    Product ID  <input class="form-control" type="text" name="txtProductID" value="${param.txtProductID}" required="required" pattern="[a-zA-Z0-9]{5}" title="ex: CR001"/>

                                    Product Name  <input class="form-control" type="text" name="txtProductName"  value="${param.txtProductName}" required="required" pattern="[a-zA-Z]{1.20}"
                                                         title="Cannot contains special symbols"/>
                                    <br/><br/>
                                    Price  <input class="form-control" type="number" name="txtPrice" value="${param.txtPrice}" min="10000" required="required" />
                                    <div style="color: red">
                                    ...
                                    <c:if test="${not empty requestScope.imageData}">
                                        <img style="width: 276px;" src="data:image/png;base64,${requestScope.imageData}">

                                    </c:if>
                                       
                                    <input type="file" name="fileImage" value="" multiple="multiple" id="image" class="form-control" required="true"/>
                                    <br/><br/>

                                    Category  <select class="form-select" aria-label="Default select example" name="cate" required="true">
                                        <c:forEach var="categoryId" items="${categoryIdSet}" >
                                    ...
                                    Ingredient  <input class="form-control" type="text" name="txtIngredient" value="${param.txtIngredient}"/>
                                    <div style="color: red">
                                    ...
                                    <button
                                        style="margin:10px; background-color: white; border: 2px solid black; color: black;width:170px;margin-left:65px"
                                        name="btnAction" value="confirmCreate" class="btn">                                                

                                        <span id="confirmCreate">Create</span>
                                    </button>
                                </form>					
