<%-- 
    ...
    Created on : Jan 16, 2021, 9:06:50 PM
...
<html
    ...
    <bodyid="accessories" class="template-collection">
                    ...
                    <div class="grid__item medium-up--one-fifth small--one-half">
                        <div class="top-bar__search">
                            ...
                            <form action="MainController" method="GET" class="search-bar small--hide"
                                ...
                                <input type="text" name="txtSearchValue" class="search-bar__input" value=""
                            ...
                            <div id="SiteNav" class="site-nav" role="menu">
                                <ul class="list--nav">
                                    ...
                                    <!--                                    <li class="site-nav__item site-nav--active">
                                                                            <a href="MainController?btnAction=Search&txtSearchValueValue=" class="site-nav__link" aria-current="page"></a>
                                                                        </li>-->
                    ...
                    <div id="shopify-section-collection-template" class="shopify-section">
                        ...
                        <div data-section-id="collection-template" data-section-type="collection-template"
                            ...
                            <form action="MainController" enctype="multipart/form-data" method="POST" >
                                ...
                                <c:set var="dto" value="${requestScope.PRODUCTINFO}"/>
                                <c:if test="${not empty dto}">
                                    Product ID  <input class="form-control" type="text" name="txtProductID" value="${dto.productId}" readonly="true" required="required"/>

                                    Product Name  <input class="form-control" type="text" name="txtProductName"  value="${dto.productName}" required="required"/>
                                    <div style="color: red">
                                    ...
                                    <img style="width: 276px;" src="data:image/png;base64,${dto.image}"> 

                                    <input type="file" name="fileImage" value="" multiple="multiple" id="image" class="form-control" />
                                    <br/>

                                    Category  <select class="form-select" name="cate" aria-label="Default select example">
                                        <option selected value="${dto.getCateKey(dto.category)}">${dto.category}</option>
                                        <c:forEach var="categoryId" items="${categoryIdSet}" >
                                            <option value="${categoryId}">${category.get(categoryId)}</option>
                                        </c:forEach>
                                    </select><br/><br/>

                                    Price  <input class="form-control" type="number" name="txtPrice" value="${dto.price}" min="1" required="required" />
                                    <div style="color: red">

                                    </div><br/>

                                    Quantity  <input class="form-control" type="number" name="txtQuantity" value="${dto.quantity}" min="1" required="required"/>
                                    <div style="color: red">

                                    </div><br/>
                                    
                                    Ingredient  <input class="form-control" type="text" name="txtIngredient" value="${dto.ingredient}"/>
                                    <div style="color: red">

                                    </div></br>
                                    Description  <input class="form-control" type="text" name="txtDescription" value="${dto.desription}"/>
                                    <div style="color: red">

                                    </div></br>
                                    Status  <select class="form-select" name="txtStatus" aria-label="Default select example">
                                        <option selected value="${dto.status}">${dto.status}</option>
                                        <option value="active">Active</option>
                                        <option value="inactive">Inactive</option>
                                    </select><br/>
                                    <button
                                        style="margin:10px; background-color: white; border: 2px solid black; color: black;width:170px;margin-left:65px"
                                        name="btnAction" value="confirmUpdate" class="btn">                                                

                                        <span id="confirmCreate">Update product</span>
                                    </button>
