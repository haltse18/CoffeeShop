...
public class SearchByCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtid = request.getParameter("CateId");
        ...
        try {
            if (txtid != null) {
                ...
                ArrayList<ProductDTO> result = dao.searchProductByCategory(id, noPage,status);
//                out.append("result size: " + result.size());
                ArrayList<ProductDTO> fullResult = dao.searchProductByCategory(id,status);
//                out.append("fullResult size: " + fullResult.size());
