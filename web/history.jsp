<%-- 
    Document   : history
    Created on : Jan 27, 2021, 12:50:21 PM
                    ...
                    <div class="grid__item medium-up--one-fifth small--one-half">
                        <div class="top-bar__search">
                            ...
                            <form action="MainController" method="GET" class="search-bar small--hide"
                                  role="search">
                                <button type="submit" name="btnAction" value="Search by name"
            ...
            <div class="grid">
                ...
                <main class="main-content grid__item medium-up--four-fifths" id="MainContent" role="main">
                    ...
                    <div id="shopify-section-collection-template" class="shopify-section">
                        <!-- /templates/collection.liquid -->
                        <header class="grid">
                            <h1 class="grid__item small--text-center medium-up--one-third">History</h1>
                            <div class="collection-sorting grid__item medium-up--two-thirds medium-up--text-right small--text-center">


                                <form action="MainController"  class="search-bar small--hide"
                                      role="search">
                                    <button type="submit" name="btnAction" value="Search history by name"
                                            class="search-bar__submit">
                                        <svg aria-hidden="true" focusable="false" role="presentation"
                                             class="icon icon-search" viewBox="0 0 20 20">
                                        <path fill="#444"
                                    ...
                                    <input type="text" name="txtSearchHistory" class="search-bar__input" 
                                           placeholder="Search history" aria-label="Search">

                                    <label for="history">Order date:</label>
                                    <input type="date" id="history" name="txtOrderDate">
                                    <button type="submit" name="btnAction" value="SearchHistoryByDate" class="btn" >
                                        Search
                                    </button>
                                    <input type="hidden" name="purpose" value="shop" />
                                </form>
                        ...
                        <div class="grid">
                            <div class="grid__item">
                                ...
                                <c:set var="map" value="${requestScope.HISTORYMAP}"/>
                                <c:if test="${not empty map}">
                                    <c:forEach var="orderId" items="${map.keySet()}">
                                        ...
                                        <table class="cart-table responsive-table table--no-border">
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="history" items="${map.get(orderId)}" varStatus="counter">
                                                ...
                                                <form action="MainController"  method="GET" novalidate="" class="cart">
                                                    <tr class="cart__row responsive-table__row">
                                                        <td class="cart__table-cell--image small--text-center">
                                                            ...
                                                            <div id="CartImageWrapper--4733548036118" class="cart__image-wrapper supports-js" >
                                                                <a class="cart__image-container"  style="padding-top:100.0%;">
                                                                    <img id="CartImage--4733548036118" class="cart__image lazyautosizes lazyloaded" src="data:image/png;base64,${history.image}" data-widths="[180, 230, 360, 540, 720, 900, 1080, 1500, 1512, 1728, 2048]" data-aspectratio="1.0"
                                                            ...
                                                            <a
                                                                ...
                                                                <img class="cart__image"
                                                                 src="data:image/png;base64,${history.image}"
                                                                 >
                                                            </a>
                                                            </noscript>
                                                        </td>
                                                        ...
                                                        <td class="cart__table-cell--price medium-up--text-right" data-label="Price">
                                                            ${history.convertPrice(history.price)}₫
                                                        ...
                                                        <td data-label="Total" class="text-right cart__table-cell--line-price">
                                                            ${history.convertPrice(history.quantity*history.price)}₫
                                                        </td>
                                        ...
                                        <footer class="cart__footer">
                                            <div class="grid">
                                                <div class="grid__item large-up--one-half">
                                                    <label for="CartSpecialInstructions" class="label--block">Order Date:</label>
                                                    <span>${map.get(orderId).get(0).getOrderTime()}</span>
                                                </div>
                                                <div class="grid__item text-center large-up--one-half large-up--text-right">
                                                    <p>
                                                        <span class="cart__subtotal-title h3">Total </span>
                                                        <c:set var="total" value="${map.get(orderId).get(0)}"/>
                                                        <span class="cart__subtotal h3">${total.convertPrice(total.getTotal())}₫</span>
                                                    </p>
